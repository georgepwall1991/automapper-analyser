...
internal sealed class CreateMapRegistry
{
    ...
    private readonly Dictionary<InvocationExpressionSyntax, (string Source, string Dest, Location Location)> _duplicates;
    ...
    /// </summary>
    public Dictionary<InvocationExpressionSyntax, (string Source, string Dest, Location Location)> GetDuplicateMappings()
    {
        return _duplicates;
    }
    ...
    public static CreateMapRegistry Build(Compilation compilation)
    {
        ...
        var groups = mappings.GroupBy(m => (m.Source, m.Destination), new MappingComparer());
    ...
    {
        public bool Equals((ITypeSymbol Source, ITypeSymbol Destination) x, (ITypeSymbol Source, ITypeSymbol Destination) y)
        {
