...
namespace AutoMapperAnalyzer.Analyzers
{
    ...
    {
        public static readonly DiagnosticDescriptor PropertyTypeMismatchRule = new DiagnosticDescriptor(
            "AM001",
            ...
            description: "Source and destination properties have incompatible types that require explicit conversion configuration."
        );
        ...
        public static readonly DiagnosticDescriptor NullableCompatibilityRule = new DiagnosticDescriptor(
            ...
            isEnabledByDefault: true,
            description: "Nullable source property mapped to non-nullable destination property may cause null reference exceptions."
        );

        public static readonly DiagnosticDescriptor GenericTypeMismatchRule = new DiagnosticDescriptor(
            "AM001",
            ...
            DiagnosticSeverity.Error,
            isEnabledByDefault: true,
            description: "Generic type parameters are incompatible and require explicit conversion configuration."
        );

        public static readonly DiagnosticDescriptor ComplexTypeMappingMissingRule = new DiagnosticDescriptor(
            "AM001",
            ...
            DiagnosticSeverity.Warning,
            isEnabledByDefault: true,
            description: "Complex types require explicit mapping configuration to ensure proper property mapping."
        );
            ...
            INamedTypeSymbol destinationType)
        {
            ...
            var destinationProperties = GetPublicProperties(destinationType);
        ...
        private static void AnalyzePropertyTypeCompatibility(
            ...
            INamedTypeSymbol destinationType)
        {
            var sourceTypeName = sourceProperty.Type.ToDisplayString();
            var destTypeName = destinationProperty.Type.ToDisplayString();
        ...
        private static bool HasImplicitConversion(ITypeSymbol from, ITypeSymbol to)
        {
            ...
            var fromTypeName = from.ToDisplayString();
            var toTypeName = to.ToDisplayString();
        ...
        private static bool IsPrimitiveOrFrameworkType(ITypeSymbol type)
        {
            ...
            var primitiveAndFrameworkTypes = new[]
            {
