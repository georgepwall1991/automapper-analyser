...
namespace AutoMapperAnalyzer.Analyzers
{
    ...
    public class AM002_NullableCompatibilityAnalyzer : DiagnosticAnalyzer
    {
        ...
        /// </summary>
        public static readonly DiagnosticDescriptor NullableToNonNullableRule = new DiagnosticDescriptor(
            "AM002",
            ...
            description: "Source property is nullable but destination property is non-nullable, which could cause null reference exceptions at runtime.");

        /// <summary>
        /// AM002: Non-nullable to nullable assignment (informational)
        /// </summary>
        public static readonly DiagnosticDescriptor NonNullableToNullableRule = new DiagnosticDescriptor(
            "AM002",
            ...
            isEnabledByDefault: true,
            description: "Non-nullable source property is being mapped to nullable destination property.");
            ...
            INamedTypeSymbol destinationType)
        {
            ...
            if (IsNullableType(sourceProperty.Type) && !IsNullableType(destinationProperty.Type))
            {
                ...
                var sourceUnderlyingType = GetUnderlyingType(sourceProperty.Type);
                var destUnderlyingType = GetUnderlyingType(destinationProperty.Type);
