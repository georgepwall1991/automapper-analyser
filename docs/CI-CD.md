...
- **Current**: 2.30.109
- **Pre-release**: 2.30.109-preview, 2.30.109-beta
...
dotnet run --project tools/AnalyzerVerifier -- --verify-package-compatibility ./packages/AutoMapperAnalyzer.Analyzers.2.30.109.nupkg --case net10-am14
