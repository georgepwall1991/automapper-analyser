...
- **Current**: 2.30.98
- **Pre-release**: 2.30.98-preview, 2.30.98-beta
...
dotnet run --project tools/AnalyzerVerifier -- --verify-package-compatibility ./packages/AutoMapperAnalyzer.Analyzers.2.30.98.nupkg --case net10-am14
