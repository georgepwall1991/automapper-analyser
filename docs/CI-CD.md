...
- **Current**: 2.30.106
- **Pre-release**: 2.30.106-preview, 2.30.106-beta
...
dotnet run --project tools/AnalyzerVerifier -- --verify-package-compatibility ./packages/AutoMapperAnalyzer.Analyzers.2.30.106.nupkg --case net10-am14
