...
- **Current**: 2.30.103
- **Pre-release**: 2.30.103-preview, 2.30.103-beta
...
dotnet run --project tools/AnalyzerVerifier -- --verify-package-compatibility ./packages/AutoMapperAnalyzer.Analyzers.2.30.103.nupkg --case net10-am14
