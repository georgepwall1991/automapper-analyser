...
- **Current**: 2.30.108
- **Pre-release**: 2.30.108-preview, 2.30.108-beta
...
dotnet run --project tools/AnalyzerVerifier -- --verify-package-compatibility ./packages/AutoMapperAnalyzer.Analyzers.2.30.108.nupkg --case net10-am14
