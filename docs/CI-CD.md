...
- **Current**: 2.30.102
- **Pre-release**: 2.30.102-preview, 2.30.102-beta
...
dotnet run --project tools/AnalyzerVerifier -- --verify-package-compatibility ./packages/AutoMapperAnalyzer.Analyzers.2.30.102.nupkg --case net10-am14
