...
- **Current**: 2.30.87
- **Pre-release**: 2.30.87-preview, 2.30.87-beta
...
dotnet run --project tools/AnalyzerVerifier -- --verify-package-compatibility ./packages/AutoMapperAnalyzer.Analyzers.2.30.87.nupkg --case net10-am14
