...
- **Current**: 2.30.94
- **Pre-release**: 2.30.94-preview, 2.30.94-beta
...
dotnet run --project tools/AnalyzerVerifier -- --verify-package-compatibility ./packages/AutoMapperAnalyzer.Analyzers.2.30.94.nupkg --case net10-am14
