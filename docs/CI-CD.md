...
- **Current**: 2.30.92
- **Pre-release**: 2.30.92-preview, 2.30.92-beta
...
dotnet run --project tools/AnalyzerVerifier -- --verify-package-compatibility ./packages/AutoMapperAnalyzer.Analyzers.2.30.92.nupkg --case net10-am14
