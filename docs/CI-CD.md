...
- **Current**: 2.30.91
- **Pre-release**: 2.30.91-preview, 2.30.91-beta
...
dotnet run --project tools/AnalyzerVerifier -- --verify-package-compatibility ./packages/AutoMapperAnalyzer.Analyzers.2.30.91.nupkg --case net10-am14
